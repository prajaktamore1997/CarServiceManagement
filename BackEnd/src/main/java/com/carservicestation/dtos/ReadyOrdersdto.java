...
public class ReadyOrdersdto {
	...
	public static ReadyOrdersdto fromEntity(Order o) {
		ReadyOrdersdto odto= new ReadyOrdersdto();
	...
	public String toString() {
		return "ReadyOrdersdto [ordersId=" + ordersId + ", ordersDate=" + ordersDate + ", ordersStatus=" + ordersStatus
				+ ", redeemStatus=" + redeemStatus + ", serviceDate=" + serviceDate + ", serviceTime=" + serviceTime
				+ ", vehicleProblem=" + vehicleProblem + ", subPckId=" + subPckId + ", subPckName=" + subPckName
				+ ", validity=" + validity + ", status=" + status + ", custId=" + custId + ", name=" + name + ", city="
				+ city + ", area=" + area + ", address=" + address + ", email=" + email + ", mobileNo=" + mobileNo
				+ ", paymentId=" + paymentId + ", paymentDate=" + paymentDate + ", price=" + price + ", paymentMode="
				+ paymentMode + ", txnNo=" + txnNo + ", complaintId=" + complaintId + ", complaintSubject="
				+ complaintSubject + ", complaintDetail=" + complaintDetail + ", complaintResponse=" + complaintResponse
				+ ", complaintDate=" + complaintDate + ", vehicleId=" + vehicleId + ", VehicleRegNo=" + VehicleRegNo
				+ ", model=" + model + ", empId=" + empId + ", firstName=" + firstName + ", lastName=" + lastName + "]";
	}
